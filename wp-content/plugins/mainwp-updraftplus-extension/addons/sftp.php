...
class MainWP_Updraft_Plus_Addons_RemoteStorage_sftp {
	...
	public function config_print() {
			...
			?>
            <div class="ui grid field mwp_updraftplusmethod sftp">
                    ...
                    <div class="ui ten wide column">
                        <em><?php _e( 'Resuming partial uploads is supported for SFTP, but not for SCP. Thus, if using SCP then you will need to ensure that your webserver allows PHP processes to run long enough to upload your largest backup file.', 'mainwp-updraftplus-extension' ); ?></em>
                        ...
                        <div class="ui hidden fitted divider"></div>
                        <input type="<?php echo apply_filters( 'mainwp_updraftplus_admin_secret_field_type', 'password' ); ?>" autocomplete="off" style="width: 292px" id="updraft_sftp_settings_pass" name="mwp_updraft_sftp_settings[pass]" value="<?php echo $pass; ?>" />
                        ...
                        <div class="ui hidden fitted divider"></div>
                        <?php _e( 'Key', 'mainwp-updraftplus-extension' ); ?>:
                        <div class="ui hidden fitted divider"></div>
                        ...
                        <div class="ui hidden fitted divider"></div>
                        <?php _e( 'Directory path', 'mainwp-updraftplus-extension' ); ?>:
                        <div class="ui hidden fitted divider"></div>
